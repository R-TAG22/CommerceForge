...
export const INITIAL_WEBSITE_CONTENT: WebsiteContent = {
  ...
  header: {
    ...
    brandTagline: 'WEB PERFORMANCE STUDIO',
    ctaText: 'HIRE US',
    ctaAction: 'inquiry',
    ctaVisible: true,
    navItems: [
  ...
  hero: {
    ...
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: new Date().toISOString(),
    eyebrowText: 'Web Design & Performance Studio',
  ...
  comparison: {
    ...
    newColumnHeading: 'The Rebuilt Way (Handcrafted Studio Code)',
  ...
  footer: {
    ...
    copyrightText: 'CommerceForge Studio. All rights reserved. Transparent web design for local businesses.',
    socialLinks: [],
    columns: [
      {
        id: 'col-1',
      ...
      },
      {
        ...
        links: [
          ...
          { id: 'l-11', label: 'About the Studio', url: 'about' },
