...
export const INITIAL_WEBSITE_CONTENT: WebsiteContent = {
  ...
  hero: {
    ...
    headlineLine1: 'TURN VISITORS',
    headlineLine2: 'INTO',
    headlineHighlight: 'BUYERS',
    headlineLine3: '',
    description: 'We rebuild slow, outdated site into high-speed sales engines. Handcrafted, mobile-first and delivered in 7 days.',
    priceAnchor: '$159',
  ...
  comparison: {
    ...
    headingPrefix: 'PERFORMANCE AS PRESTIGE: THE ENGINEERED ADVANTAGE',
    headingLoss: '',
    headingWin: '',
    subheading: 'A streamlined breakdown of traditional builds vs. our engineering-first infrastructure.',
    oldColumnHeading: 'TRADITIONAL BUILD (DESIGN-FIRST)',
    oldColumnSubtitle: 'High latency, fragile layouts & plugin bloat',
    oldColumnResult: 'Result: Lost conversions, high bounce rates & penalised Core Web Vitals.',
    newColumnHeading: 'ENGINEERED BUILD (INFRASTRUCTURE-FIRST)',
